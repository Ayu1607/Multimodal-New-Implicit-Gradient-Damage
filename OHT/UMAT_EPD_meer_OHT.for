...
!     
     ...
     + NEWTON=10,TOLER=1.D-6, NGP = 8, NEL = 25470 ,HALF=0.5D0
     1, FOURTH=.25D0)   
...
! CALCULATE THRESHOLD ENERGIES IF DAMAGE HAS JUST BEGUN
      ...
      PHI_S_IFF1 = MAX( (GC_T /LC - PHI_C_IFF1), 0.0001D0 )
      PHI_S_IFF2 = MAX( (GC_C /LC - PHI_C_IFF2), 0.0001D0 )
      PHI_S_IFF3 = MAX( (GC_S /LC - PHI_C_IFF3), 0.0001D0 )
      PHI_S_FF1  = MAX( (GC_FT/LC - PHI_C_FF1 ), 0.0001D0 )
      PHI_S_FF2  = MAX( (GC_FC/LC - PHI_C_FF2 ), 0.0001D0 )
...
C === PARAMETERS ===
      PARAMETER (NGP=8,ZERO=0.D0, ONE=1.D0, NINPT=8, NEL=25470)
      COMMON/KUSER/USRVAR(NEL,20,NGP),TIME_VAR,ITER_VAR
